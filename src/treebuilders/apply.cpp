...
template void apply<3>(double prec,
                       ...
                       int maxIter,
                       bool absPrec);
template void apply_far_field<1>(double prec,
                              FunctionTree<1> &out,
                              ConvolutionOperator<1> &oper,
                              FunctionTree<1> &inp,
                              int maxIter,
                              bool absPrec);
template void apply_far_field<2>(double prec,
                              FunctionTree<2> &out,
                              ConvolutionOperator<2> &oper,
                              FunctionTree<2> &inp,
                              int maxIter,
                              bool absPrec);
template void apply_far_field<3>(double prec,
                              FunctionTree<3> &out,
                              ConvolutionOperator<3> &oper,
                              FunctionTree<3> &inp,
                              int maxIter,
                              bool absPrec);
template void apply_near_field<1>(double prec,
                               FunctionTree<1> &out,
                               ConvolutionOperator<1> &oper,
                               FunctionTree<1> &inp,
                               int maxIter,
                               bool absPrec);
template void apply_near_field<2>(double prec,
                               FunctionTree<2> &out,
                               ConvolutionOperator<2> &oper,
                               FunctionTree<2> &inp,
                               int maxIter,
                               bool absPrec);
template void apply_near_field<3>(double prec,
                               FunctionTree<3> &out,
                               ConvolutionOperator<3> &oper,
                               FunctionTree<3> &inp,
                               int maxIter,
