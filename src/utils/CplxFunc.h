...
class CplxFunc  {
public:
    CplxFunc(std::shared_ptr<ComplexFunction> funcptr);
    CplxFunc(const CplxFunc &func);
    CplxFunc(int spin = 0, int occ = -1, int rank = -1, bool share = false);
    CplxFunc &operator=(const CplxFunc &func);
    CplxFunc paramCopy() const;
    ...
    void add(ComplexDouble c, CplxFunc inp);
    void absadd(ComplexDouble c, CplxFunc inp);
...
namespace cplxfunc {
    ...
    ComplexDouble dot(CplxFunc bra, CplxFunc ket);
    ComplexDouble node_norm_dot(CplxFunc bra, CplxFunc ket, bool exact);
    void deep_copy(CplxFunc &out, CplxFunc &inp);
    ...
    void multiply(CplxFunc &out,
                  CplxFunc inp_a,
                  CplxFunc inp_b,
                  double prec,
                  bool absPrec = false,
                  bool useMaxNorms = false);
    void multiply_real(CplxFunc &out,
                       CplxFunc inp_a,
                       CplxFunc inp_b,
                       double prec,
                       bool absPrec = false,
                       bool useMaxNorms = false);
    void multiply_imag(CplxFunc &out,
                       CplxFunc inp_a,
                       CplxFunc inp_b,
                       double prec,
                       bool absPrec = false,
...
class MPI_FuncVector : public std::vector<CplxFunc> {
public:
