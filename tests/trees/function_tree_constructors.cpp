...
namespace function_tree_constructors {
    ...
    SCENARIO("FunctionTree basic constructor", "[function_tree_ctor_basic][function_tree_constructors][trees]") {
    ...
    SCENARIO("FunctionTree named constructor", "[function_tree_ctor_name][function_tree_constructors][trees]") {
    ...
    SCENARIO("FunctionTree shared-memory constructor with nullptr", "[function_tree_ctor_shmem][function_tree_constructors][trees]") {
    ...
    SCENARIO("Construct complex FunctionTree from two real FunctionTrees",
             "[function_tree_complex_constructor], [function_tree], [function_tree_constructors], [trees]") {
